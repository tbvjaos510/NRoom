...
namespace NRoom.Droid
{
    public class NMapCalloutCustomOldOverlay : NMapCalloutOverlay
    {
        ...
        private static int CALLOUT_TEXT_COLOR = 0xFFFFFFFF;
        private static float CALLOUT_TEXT_SIZE = 16.0F;
        private static Typeface CALLOUT_TEXT_TYPEFACE = null;//Typeface.DEFAULT_BOLD;

        private static float CALLOUT_RIGHT_BUTTON_WIDTH = 50.67F;
        private static float CALLOUT_RIGHT_BUTTON_HEIGHT = 34.67F;

        private static float CALLOUT_MARGIN_X = 9.33F;
        private static float CALLOUT_PADDING_X = 9.33F;
        private static float CALLOUT_PADDING_OFFSET = 0.45F;
        private static float CALLOUT_PADDING_Y = 17.33F;
        private static float CALLOUT_MIMIMUM_WIDTH = 63.33F;
        private static float CALLOUT_TOTAL_HEIGHT = 64.0F;
        private static float CALLOUT_BACKGROUND_HEIGHT = CALLOUT_PADDING_Y + CALLOUT_TEXT_SIZE + CALLOUT_PADDING_Y;
        private static float CALLOUT_ITEM_GAP_Y = 0.0F;
        private static float CALLOUT_TAIL_GAP_X = 6.67F;
        private static float CALLOUT_TITLE_OFFSET_Y = -2.0F;

        private TextPaint mTextPaint = new TextPaint();
        private float mOffsetX, mOffsetY;

        private float mMarginX;
        private float mPaddingX, mPaddingY, mPaddingOffset;
        private float mMinimumWidth;
        private float mTotalHeight;
        private float mBackgroundHeight;
        private float mItemGapY;
        private float mTailGapX;
        private float mTitleOffsetY;

        private Drawable mBackgroundDrawable;
        protected Rect mTemp2Rect = new Rect();
        private Rect mRightButtonRect;
        private String mRightButtonText;
        private int mCalloutRightButtonWidth;
        private int mCalloutRightButtonHeight;
        private Drawable[] mDrawableRightButton;
        private int mCalloutButtonCount = 1;
        ...
        public NMapCalloutCustomOldOverlay(NMapOverlay itemOverlay, NMapOverlayItem item, Rect itemBounds,
                                           NMapCalloutCustomOldOverlay.IResourceProvider resourceProvider)
        {
    ...
    protected void drawCallout(Canvas canvas, NMapView mapView, boolean shadow, long when)
        ...
        private void adjustTextBounds(NMapView mapView)
        {
            ...
            if (mTitleTruncated == null || mWidthTitleTruncated != mapViewWidth)
            {
                ...
                String title = TextUtils.ellipsize(mOverlayItem.getTitle(), mTextPaint, maxWidth,
            ...
            float dy = (mBackgroundHeight - mTempRect.height()) / 2;
            ...
            {
                float dx = (mMinimumWidth - mTempRectF.width()) / 2;
